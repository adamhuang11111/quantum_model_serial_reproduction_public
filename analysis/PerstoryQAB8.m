function [nLL,P0s] = PerstoryQAB8(x, data)
%This model corresponds to QAB8 in the paper, where participants are modeled
%by a mixed quantum state that is a convex combination of two 
%pure states and a changing observation noise
