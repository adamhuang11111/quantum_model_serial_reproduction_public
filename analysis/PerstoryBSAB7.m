function [nLL, P0s] = PerstoryBSAB7(x, data)
%This model corresponds to BSAB7 in the paper, where sparticipants in the
%serial reproduction are assumed to come from a mixture of two Gaussian
%distributions, and observation noise is changing
